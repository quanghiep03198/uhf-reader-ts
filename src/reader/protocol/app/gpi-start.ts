/**
 * GPI trigger start push notification.
 *
 * Mirrors Python `app_gpiStart.py`.  Sent by the reader when a GPI
 * (General Purpose Input) trigger event starts.
 */
...
/**
 * Log message indicating a GPI trigger event has started.
 */
export class LogGpiStart extends Message {
  /** GPI port number. */
  ...
  constructor() {
    ...
    this.msgId = EnumG.AppLogMid_gpi;
  }
  ...
  /**
   * String representation of this GPI start event.
   *
