/**
 * GB tag inventory push notification.
 *
 * Mirrors Python `log_base_gb_info.py`.  Sent by the reader when a GB
 * (Chinese national standard) tag is detected during inventory.
 */
...
/**
 * Log message carrying information about a single GB tag read.
 */
export class LogBaseGbInfo extends Message {
  ...
  constructor() {
    ...
    this.msgId = EnumG.BaseLogMid_Gb;
  }
