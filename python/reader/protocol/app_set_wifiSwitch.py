...
class MsgAppSetWifiSwitch(Message):

    def __init__(self, wifiSwitch: int):
        super().__init__()
        self.mt_8_11 = EnumG.Msg_Type_Bit_App.value
        self.msgId = EnumG.AppMid_SetWifiOnOff.value
        self.wifiSwitch = wifiSwitch
